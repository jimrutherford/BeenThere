...
// HOOHoodie
#define COCOAPODS_POD_AVAILABLE_HOOHoodie
#define COCOAPODS_VERSION_MAJOR_HOOHoodie 0
#define COCOAPODS_VERSION_MINOR_HOOHoodie 2
#define COCOAPODS_VERSION_PATCH_HOOHoodie 2
